...
function About() {
 return (
   <section className="row m-0">
     <div className="col-md-8 container-fill bg-success text-center text-light pt-5 px-5">
       ...
       <p className="m-5">Duis at tellus at urna. Ipsum dolor sit amet consectetur adipiscing elit. Elementum integer enim neque volutpat ac tincidunt vitae semper quis. Dolor purus non enim praesent elementum. Malesuada proin libero nunc consequat interdum</p>
       <p className="m-5">Adipiscing elit duis tristique sollicitudin nibh sit. Tempus urna et pharetra pharetra massa massa ultricies mi quis. Consequat interdum varius sit amet mattis. Sed risus ultricies tristique nulla aliquet enim. Suspendisse potenti nullam ac tortor vitae purus. Bibendum enim facilisis gravida neque convallis a cras semper.</p>
